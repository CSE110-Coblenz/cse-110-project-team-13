...
export const historicalImage = document.getElementById("historical-image");
...
let dragStartY = 0;
let hasMoved = false;
export function isImageLockedInPlace() {
    return isImageLocked;
}
// Flip image to show hint
export function toggleHint(e) {
    hintText;
    e.stopPropagation();
    e.preventDefault();
...
// Maximize/Minimize image
export function toggleMaximize(e) {
    e.stopPropagation();
    e.preventDefault();
...
export function loadHistoricalImage(imageSrc, hint) {
...
export function disableDoubleClickOnImage() {
    4;
